...
function JUEGOlvl2(){
    ...
    function Tiempo_Disminurlvl2(){ //FUNCION QUE REDUCE EL TIEMPO Y RESETEAL EL RESULTADO UNA VEZ LLEGUE A 0
        ...
        if(Tiempolvl2 == 0){
            Tiempolvl2 = 61
            Puntajelvl2 = 0
            alert("El tiempo se agoto, lo lamento de seguro lo lograras para la siguiente")} }
        ...
        function Aumentar_Puntoslvl2(){
            ...
            if(Puntajelvl2 == 38){
                ...
                Swal.fire({
                    ...
                    html: '¿VERDAD QUE FUE DIFICIL?, Preparate para el siguiente nivel que las cosas va a empeorar y agradecemos tu dedicacion en pasar este nivel, esperemos que puedas seguir defendiendo la tierra de esa manera y mejores tu habilidad de reaccion ',
                    icon: 'sucess',
