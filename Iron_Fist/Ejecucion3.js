...
function JUEGOlvl3() {
    ...
    function Aumentar_Puntoslvl3() {
        Puntajelvl3++;
        document.getElementById("Puntajelvl3").innerHTML = Puntajelvl3 + " / 42"
        if (Puntajelvl3 == 42) {
            Puntajelvl3 = 0
            Tiempolvl3 = 51
            function Contactos(){
            Swal.fire({
                ...
                html: '<b class="Aumentar puntos">Sabia que lo lograrias, nos savlaste de la destruccion, pero ahora nos espera otra lucha, esperemos vovlerte a ver jugando iron fist 2 en un futuro <br><br> CONTACTOS:<br><br> 71727432@certus.edu.pe <br><br> 71663265@certus.edu.pe <br><br> 70845813@certus.edu.pe <br> </b>',
                icon: 'sucess',
